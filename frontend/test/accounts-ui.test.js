...
${accountEditors}`;
  ...
  assert.match(mobileExperience, /investment \? "Cash RDN" : "Dana tersedia"/);
  ...
  assert.match(desktopWorkspace, /Cash RDN · detail aset tersedia di catatan Investasi/);
  assert.match(mobileExperience, /investment \? "Cash RDN" : "Dana tersedia"/);
  ...
  assert.match(desktopWorkspace, /Tren seluruh rekening/);
