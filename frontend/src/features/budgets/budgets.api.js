...
export const createBudgetsBatch = (payload, options) => apiClient.request("budgets.batchCreate", payload, options);
...
export const removeBudget = (payload, options) => apiClient.request("budgets.remove", payload, options);
