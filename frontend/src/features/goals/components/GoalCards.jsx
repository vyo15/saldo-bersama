...
const GoalSummary = ({ items }) => {
  ...
  return (
    <Card className={goalClass("goal-summary")} aria-labelledby="goal-summary-title">
      <div className={goalClass("goal-summary__content")}>
        ...
        <p className={goalClass("goal-summary__description")}>Terkumpul dari target <Money value={summary.target} />.</p>
