...
import { GoalConfirmations, GoalCreateModal, GoalEditModal } from "./GoalDialogs.jsx";

const GoalDialogLayer = ({ reminderTarget, onReminderClose, creation, creationAccounts, investmentPortfolios, lifecycle }) => <>
  <ManualReminderModal target={reminderTarget} onClose={onReminderClose} />
  <GoalCreateModal open={creation.open} close={creation.closeCreate} form={creation.form} setForm={creation.setForm} accounts={creationAccounts} investmentPortfolios={investmentPortfolios} createGoal={creation.createGoal} createMutation={creation.createMutation} message={creation.message} />
