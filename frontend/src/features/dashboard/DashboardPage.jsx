...
const DashboardPageContent = () => {
  ...
  const surfaces = { mobileLayout, displayOverview, bootstrap: safeBootstrap, dashboardViewModel, investmentSummary, user, displayName, balanceVisible, setBalanceVisible, openQuickRecord, openMobileTransactionDetail, desktopAccountId, setDesktopAccountId, filters, setters };
