...
const DashboardSurfaces = ({ mobileLayout, displayOverview, bootstrap, dashboardViewModel, investmentSummary, user, displayName, balanceVisible, setBalanceVisible, openTransactionComposer, openMobileTransactionDetail, desktopAccountId, setDesktopAccountId, filters, setters }) => {
  return (
