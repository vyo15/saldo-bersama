...
const SETTINGS_NAVIGATION = Object.freeze([
  ...
  { to: "/pengaturan/anggota", label: "Akses anggota", icon: FiUsers, ownerOnly: true },
  ...
  { to: "/pengaturan/reset-data", label: "Reset data percobaan", icon: FiRefreshCw, ownerOnly: true },
