...
const MobileNavigation = ({ onQuickAdd, onMore, moreOpen = false, quickAddDisabled = false }) => {
  ...
  return (
    <nav className="mobile-navigation" aria-label="Navigasi mobile">
      ...
      <button type="button" className="mobile-navigation__add" data-preload-action="transaction" onClick={onQuickAdd} aria-label="Catat transaksi" title="Catat transaksi" disabled={quickAddDisabled}><FiPlus aria-hidden="true" /></button>
