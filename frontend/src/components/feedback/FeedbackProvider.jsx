...
const ACTION_MODULES = Object.freeze({
  ...
  periods: "Periode",
  reconciliations: "Pastikan saldo sesuai",
...
const ACTION_LABELS = Object.freeze({
  ...
  "investments.portfolios.create": ["Menyiapkan catatan investasi...", "Catatan investasi siap"],
  "investments.assets.create": ["Menyimpan posisi investasi...", "Investasi berhasil ditambahkan"],
  ...
  "investments.reconciliations.create": ["Mencocokkan investasi lama...", "Pencocokan investasi lama berhasil disimpan"],
  ...
  "budgets.upsert": ["Menyimpan kebutuhan...", "Kebutuhan berhasil disimpan"],
  "budgets.archive": ["Mengarsipkan kebutuhan...", "Kebutuhan berhasil diarsipkan"],
  "budgets.deleteUnused": ["Menghapus kebutuhan...", "Kebutuhan berhasil dihapus"],
  ...
  "envelopes.create": ["Membuat Alokasi Dana...", "Alokasi Dana berhasil dibuat"],
  "envelopes.adjustAllocation": ["Memperbarui dana alokasi...", "Dana alokasi berhasil diperbarui"],
  "envelopes.move": ["Memindahkan dana...", "Dana berhasil dipindahkan"],
  ...
  "reconciliations.create": ["Membandingkan saldo...", "Pemeriksaan saldo tersimpan"],
