...
- Pemilih **Alokasi manual** di composer transaksi desktop/mobile dihapus. Relasi Alokasi mengikuti Kebutuhan yang dipilih atau smart matching canonical; pengeluaran biasa tetap dapat dicatat sebagai `Tanpa Kebutuhan`, tetapi hanya setelah pilihan tersebut dilakukan secara eksplisit; state belum memilih tidak lagi disamakan dengan dana bebas.
...
- Guard P0 transaksi membedakan **belum memilih Kebutuhan** dari intent eksplisit **Tanpa Kebutuhan**: multi-kandidat wajib dipilih sebelum submit, perubahan rekening/kategori/tanggal menghitung ulang relasi, context Kebutuhan dari Alokasi dipertahankan, dan preview dampak menyebut sumber pengurangan dana secara eksplisit.
