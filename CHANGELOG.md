...
- Menambahkan **Komitmen** pada Perencanaan untuk KPR, cicilan, pinjaman, dan Arisan. Schema v22 menambah `commitments`/`commitment_movements`, menghubungkan satu Jadwal Rutin canonical per Komitmen, memisahkan pokok vs bunga/biaya bila sisa pokok diketahui, mendukung penerimaan Arisan, autodebet sebagai penanda konfirmasi aktual, lifecycle selesai/reversal, report/export, notification, realtime invalidation, integrity, backup/restore, trial/full reset, dan dokumentasi governance.
...
- Merapikan Dashboard poin 13 agar tidak berubah menjadi mini rekening-koran: Beranda tetap memprioritaskan **Dana Tersedia**, mempertahankan **Saldo rekening** dan **Aman dipakai / hari**, menambahkan ringkasan **Masuk / Keluar** bulan berjalan, serta mengganti shortcut depan menjadi **Alokasi / Rekening / Target / Cocokkan**. Detail `Debit / Kredit / Saldo` tetap menjadi domain Laporan/riwayat, sehingga fungsi tidak dobel dan mobile tetap padat.
- Mengubah hierarchy saldo Beranda: **Dana Tersedia** (`safeToSpend`) kini menjadi angka utama mobile/desktop, sedangkan Saldo rekening non-investasi turun menjadi konteks sekunder dan Aman dipakai / hari tetap terlihat. Read-model Dana Tersedia juga diperbaiki agar Jadwal Rutin yang sudah didanai melalui Kebutuhan dalam Alokasi tidak dicadangkan dua kali; ledger, saldo fisik, dan mutation finansial tetap tidak berubah. Sekaligus memecah complexity pada dialog/controller Kebutuhan tanpa menonaktifkan ESLint.
