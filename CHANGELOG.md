...
- Meningkatkan **Smart Transaction** tanpa schema/API baru: composer mobile memindahkan tanggal/metode/catatan ke `Detail tambahan`, satu Kebutuhan matching dihubungkan otomatis, kandidat ambigu wajib dipilih, Alokasi manual tetap advanced, dan preview lokal menampilkan perkiraan sisa Kebutuhan/Dana Tersedia/saldo rekening. Preview edit sekarang mereverse dampak transaksi lama sebelum menerapkan nilai baru; setelah create, success overlay memakai snapshot server terbaru bila refresh berhasil. Konfirmasi dua langkah `Simpan tetap` untuk expense tanpa Alokasi Dana, duplicate/overspend guard, serta transfer approval sengaja tetap dipertahankan. Sekaligus memecah complexity pada dialog/controller Kebutuhan tanpa menonaktifkan ESLint.
