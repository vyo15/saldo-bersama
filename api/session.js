import { assertAllowedOrigin, clearSessionCookie, createSessionCookie, findAllowedUser, readSession } from "./_lib/security.js";
...
export default async function handler(request, response) {
  try {
    ...
    return fail(response, error.status || 500, error.code || "SESSION_ERROR", error.status ? error.message : "Sesi tidak dapat diproses.");
  }
}
