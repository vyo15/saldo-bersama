...
export const ACTION_PERMISSIONS = Object.freeze({
  owner: new Set([
    ...
    "budgets.list", "budgets.batchCreate", "budgets.upsert", "budgets.previewLifecycle", "budgets.remove", "budgets.archive", "budgets.deleteUnused", "budgets.restore", "goals.list", "goals.create", "goals.update", "goals.previewLifecycle", "goals.archive", "goals.deleteUnused", "goals.move", "goals.reverseMovement", "goals.restore", "reports.monthly",
  ...
  member: new Set([
    ...
    "budgets.list", "budgets.batchCreate", "budgets.upsert", "budgets.previewLifecycle", "budgets.remove", "goals.list", "goals.create", "goals.update", "goals.move", "goals.reverseMovement", "reports.monthly", "reconciliations.list", "reconciliations.create",
