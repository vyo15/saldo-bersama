...
export const ACTION_PERMISSIONS = Object.freeze({
  owner: new Set([
    "system.health", "sync.state", "app.initialState", "bootstrap.get", "users.list", "users.upsert", "users.deactivate", "users.reactivate", "sessions.listOwn", "sessions.revokeOwn", "sessions.revokeAllOwn", "audit.list", "archive.list", "dashboard.overview", "investments.overview", "investments.instruments.list", "investments.assets.create", "investments.portfolios.create", "investments.instruments.upsert", "investments.trades.buy", "investments.trades.sell", "investments.valuations.update", "investments.reconciliations.create", "investments.corrections.create", "investments.openingPositions.create",
    ...
    "envelopes.list", "envelopes.create", "envelopes.createWithNeeds", "envelopes.adjustAllocation", "envelopes.move", "envelopes.close", "envelopes.previewRuleLifecycle", "envelopes.archiveRule", "envelopes.deleteUnusedRule", "envelopes.restoreRule", "envelopes.reverseMovement",
    ...
    "commitments.list", "commitments.create", "commitments.update", "commitments.archive", "commitments.recordReceipt",
    "budgets.list", "budgets.batchCreate", "budgets.upsert", "budgets.previewLifecycle", "budgets.remove", "budgets.archive", "budgets.deleteUnused", "budgets.restore", "goals.list", "goals.create", "goals.update", "goals.previewLifecycle", "goals.archive", "goals.deleteUnused", "goals.move", "goals.investments.allocate", "goals.investments.release", "goals.reverseMovement", "goals.restore", "reports.monthly",
    ...
    "notifications.center", "notifications.status", "notifications.preferences", "notifications.updatePreference", "notifications.updateSettings", "notifications.markRead", "notifications.register", "notifications.unregister", "notifications.test", "reminders.get", "reminders.upsert", "reminders.cancel", "backup.create", "import.preview", "import.apply", "restore.preview", "restore.apply", "reset.preview", "reset.status", "reset.apply", "fullReset.preview", "fullReset.status", "fullReset.apply", "integrity.run",
  ]),
  member: new Set([
    "system.health", "sync.state", "app.initialState", "bootstrap.get", "sessions.listOwn", "sessions.revokeOwn", "sessions.revokeAllOwn", "dashboard.overview", "investments.overview", "investments.instruments.list", "investments.assets.create", "investments.portfolios.create", "investments.trades.buy", "investments.trades.sell", "investments.valuations.update", "investments.reconciliations.create", "investments.openingPositions.create", "accounts.list", "accounts.requestCreate", "categories.list", "categories.requestCreate", "masterDataRequests.list", "transferRequests.list", "transferRequests.request",
    "transactions.list", "transactions.create", "transactions.update", "transactions.cancel",
    "envelopes.list", "envelopes.create", "envelopes.createWithNeeds", "envelopes.adjustAllocation", "envelopes.move", "envelopes.reverseMovement", "recurring.list", "recurring.createRule", "recurring.updateRule", "recurring.payOccurrence", "recurring.reversePayment",
    "commitments.list", "commitments.create", "commitments.update", "commitments.recordReceipt",
    "budgets.list", "budgets.batchCreate", "budgets.upsert", "budgets.previewLifecycle", "budgets.remove", "goals.list", "goals.create", "goals.update", "goals.move", "goals.investments.allocate", "goals.investments.release", "goals.reverseMovement", "reports.monthly", "reconciliations.list", "reconciliations.create",
    "notifications.center", "notifications.status", "notifications.preferences", "notifications.updatePreference", "notifications.updateSettings", "notifications.markRead", "notifications.register", "notifications.unregister", "notifications.test", "reminders.get", "reminders.upsert", "reminders.cancel", "integrations.status",
  ]),
});
