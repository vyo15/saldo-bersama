...
export const ACTION_PERMISSIONS = Object.freeze({
  owner: new Set([
    "system.health", "app.initialState", "bootstrap.get", "users.list", "users.upsert", "users.deactivate", "users.reactivate", "sessions.listOwn", "sessions.revokeOwn", "sessions.revokeAllOwn", "audit.list", "archive.list", "dashboard.overview", "investments.overview", "investments.instruments.list", "investments.assets.create", "investments.portfolios.create", "investments.instruments.upsert", "investments.trades.buy", "investments.trades.sell", "investments.valuations.update", "investments.reconciliations.create", "investments.corrections.create", "investments.openingPositions.create",
