...
export const RESET_BUSINESS_TABLES = Object.freeze([
  ...
  { table: "goal_investment_events", key: "goal_investment_event_id" },
  { table: "investment_trades", key: "trade_id" },
  { table: "goal_movements", key: "goal_movement_id" },
  { table: "budget_history", key: "budget_id" },
  { table: "budgets", key: "budget_id" },
  { table: "envelope_movements", key: "movement_id" },
  { table: "commitment_movements", key: "commitment_movement_id" },
  ...
  { table: "commitments", key: "commitment_id" },
...
export const resetSummary = (counts) => {
  ...
  return {
    ...
    budgetHistory: countFor(counts, "budget_history"),
    ...
    commitments: countFor(counts, "commitments"),
    commitmentMovements: countFor(counts, "commitment_movements"),
