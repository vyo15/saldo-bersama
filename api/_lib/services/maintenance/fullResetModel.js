...
export const FULL_RESET_DOMAIN_TABLES = Object.freeze([
  ...
  { table: "goal_investment_events", orderBy: "goal_investment_event_id", key: "goalInvestmentEvents" },
  { table: "commitment_movements", orderBy: "commitment_movement_id", key: "commitmentMovements" },
  { table: "goal_movements", orderBy: "goal_movement_id", key: "goalMovements" },
  { table: "budget_history", orderBy: "budget_id", key: "budgetHistory" },
  ...
  { table: "commitments", orderBy: "commitment_id", key: "commitments" },
...
export const FULL_RESET_OPERATIONAL_TABLES = Object.freeze([
  ...
  { table: "notification_read_states", orderBy: "user_id,notification_key,fingerprint", key: "notificationReadStates" },
  ...
  { table: "notification_settings", orderBy: "user_id", key: "notificationSettings" },
...
export const fullResetSummary = (counts) => {
  ...
  return {
    ...
    investmentTrades: tableCount(counts, "investment_trades"),
    goalInvestmentEvents: tableCount(counts, "goal_investment_events"),
    investmentCorrections: tableCount(counts, "investment_corrections"),
    investmentValuations: tableCount(counts, "investment_valuations"),
    investmentReconciliations: tableCount(counts, "investment_reconciliations"),
    commitments: tableCount(counts, "commitments"),
    commitmentMovements: tableCount(counts, "commitment_movements"),
    goals: tableCount(counts, "savings_goals"),
    goalMovements: tableCount(counts, "goal_movements"),
    budgets: tableCount(counts, "budgets"),
    budgetHistory: tableCount(counts, "budget_history"),
    ...
    investmentPortfolios: tableCount(counts, "investment_portfolios"),
    investmentInstruments: tableCount(counts, "investment_instruments"),
    ...
    notificationSettings: tableCount(counts, "notification_settings"),
    notificationReadStates: tableCount(counts, "notification_read_states"),
