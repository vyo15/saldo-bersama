...
test("backup schema v24 menyimpan data canonical termasuk pengaturan notifikasi, investasi, Target investasi, dan request kolaborasi tanpa session, binding runtime, atau bucket rate limit", async () => {
...
test("backup schema v3-v23 tetap dapat dimuat ke schema v24 dengan field additive canonical", async () => {
