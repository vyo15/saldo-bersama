...
test("dokumen arsitektur baru tersedia dan dokumen schema Sheets legacy sudah dihapus", async () => {
  for (const file of ["docs/TURSO_SCHEMA.md", "docs/GOOGLE_INTEGRATIONS.md", "docs/history/LEGACY_SHEETS_TO_TURSO_CUTOVER.md", "docs/RECOVERY_RUNBOOK.md", "docs/ENVIRONMENT_VARIABLES.md"]) assert.equal(await exists(file), true, file);
