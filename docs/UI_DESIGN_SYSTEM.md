...
- Dashboard desktop mengikuti hierarchy **financial pulse → attention → rekening/aktivitas → analitik → secondary widgets**. Empat KPI primer adalah **Saldo rekening**, **Aman digunakan**, **Arus kas bersih**, dan **Sisa anggaran**. `Saldo rekening` memakai saldo non-investasi; Cash RDN dipresentasikan terpisah pada widget Investasi. Alert actionable harus muncul sebelum modul sekunder.
