...
- Asset pengganti tetap memakai kanvas canonical 1024×645 (rasio 1.586:1), tetapi artwork harus mengisi kanvas sampai dekat tepi siluet tanpa matte hitam atau baked outer shadow. Alpha hanya dipakai di luar rounded silhouette. Semua surface `AccountVisual` yang memakai image wajib transparan; dark fallback tidak boleh terlihat melalui alpha bank. Artwork bank mendapat bleed kecil secara canonical pada Dashboard, detail/desktop, dan stack mobile agar fringe alpha tidak membentuk kotak gelap di belakang kartu.
