...
- Pilihan fixed yang sedikit tetap memakai `VisualChoiceGroup`/choice chips. Search hanya ditambahkan bila jumlah item atau taxonomy memang panjang; metadata sekunder hanya boleh tampil bila membantu keputusan (mis. dana tersedia rekening atau sisa Alokasi Dana).
