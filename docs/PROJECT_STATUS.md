...
| Alokasi Dana | Implemented | Pembuatan **Tambah Alokasi** menyimpan wadah + Kebutuhan awal dalam satu flow atomic. Pemanis kartu dan pilihan sisa return/carry tetap tersedia; period type/start/end diturunkan sistem. |
