...
- `0015-granular-personal-privacy.md` — **Rejected**; full transparency keluarga adalah policy canonical
...
- `0013-contribution-and-cost-sharing.md` mempertahankan compatibility MVP split schema v11 untuk histori/API lama; UI canonical baru tidak lagi menawarkan pembagian beban. Follow-up difokuskan pada relasi refund ke expense asli.
