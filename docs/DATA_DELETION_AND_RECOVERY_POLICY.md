...
- **Ephemeral:** `idempotency_keys`, `request_nonces`, `rate_limit_buckets`, `import_previews`, `restore_previews`. Cleanup expired existing tetap diperbolehkan sesuai guard saat ini.
