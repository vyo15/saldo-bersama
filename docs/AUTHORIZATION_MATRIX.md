...
- Komitmen mengikuti scope rekening sumber: Administrator/Member dapat create/update pada shared atau personal miliknya sendiri dan mencatat pembayaran/penerimaan yang kompatibel. `commitments.archive` tetap Administrator-only. Jadwal Rutin yang memiliki `commitment_id` hanya dapat diubah lifecycle-nya secara internal dari domain Komitmen.
