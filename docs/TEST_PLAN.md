...
- Dashboard mobile dan desktop hanya memakai `investments.overview` backend yang sama; widget tidak muncul bila belum ada portfolio dan frontend tidak menghitung financial authority sendiri.
