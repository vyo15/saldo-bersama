...
- Smart rekening hanya menyembunyikan sumber Pengeluaran dengan saldo Rp0 dan sumber Transfer dengan dana tersedia Rp0 dari daftar utama; rekening tujuan Pemasukan/Transfer tetap lengkap, rekening terpilih tetap terlihat, dan rekening `allow_negative` tidak boleh disembunyikan atau diberi warning saldo palsu. Search dan urutan recent-use tidak boleh mengubah capability backend.
