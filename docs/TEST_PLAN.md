...
- Composer transaksi expense: tepat satu Kebutuhan kompatibel auto-link `budget_id` + Alokasi; lebih dari satu kandidat meminta pilihan; nol kandidat tetap dapat disimpan sebagai Pengeluaran Belum Dialokasikan. Pemilihan Alokasi manual terpisah tidak ditampilkan. Aksi `+` dari Kebutuhan membawa context Kebutuhan/Alokasi ke composer sehingga pilihan tetap terisi walau snapshot overview sedang tertinggal atau ada Kebutuhan lain dengan kategori sama. Perubahan rekening/kategori/tanggal melepas pilihan stale dan menghitung ulang kandidat. Submit multi-kandidat tanpa pilihan wajib gagal pada field Kebutuhan; memilih `Tanpa Kebutuhan` secara eksplisit tetap melewati konfirmasi unallocated. Impact preview wajib membedakan rekening, sisa Kebutuhan, dan Dana Tersedia serta menyebut sumber pengurangan dana.
