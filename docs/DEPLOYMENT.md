...
Runtime source saat ini memakai schema v24. **Schema v24 Production harus selesai dan tervalidasi sebelum runtime v24 menerima traffic.** Latest migration canonical ditentukan oleh `database/migrations/` + `DATABASE_SCHEMA_VERSION`, bukan oleh nama section runbook ini.
