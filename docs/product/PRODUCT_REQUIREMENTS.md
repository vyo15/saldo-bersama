...
Surface **Atur Dana** boleh menampilkan total compact **Dana yang bisa dialokasikan** lintas rekening sebagai konteks aksi, tetapi angka tersebut **bukan satu kolam uang virtual** dan bukan pengganti hero **Saldo Keluarga** + konteks **Dana yang bisa kamu gunakan** di Beranda. Breakdown rekening harus tersedia, dan setiap Alokasi tetap mempunyai tepat satu rekening sumber. Flow generik **Alokasikan dana** memilih rekening sumber lebih dahulu lalu hanya menawarkan Alokasi yang memakai rekening tersebut. Kartu Alokasi tidak memiliki CTA funding atau tombol `Lihat detail`: seluruh kartu membuka detail. Penyesuaian dana contextual hanya muncul dari detail, attention/shortage, atau workflow yang memang sudah mengetahui rekening sumber + target. Rekening Bersama dapat membuat Alokasi untuk Bersama atau anggota yang diizinkan capability backend; rekening personal mengunci penerima ke pemilik rekening. Dana lintas rekening tidak boleh dicampur diam-diam: realokasi lintas rekening tetap wajib melalui Transfer.
