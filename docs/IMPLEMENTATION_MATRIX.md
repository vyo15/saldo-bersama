...
| Conflict control | `row_version` conditional update | Implemented | Browser conflict E2E pending |
...
| Browser E2E/accessibility automation | Playwright/axe | Not implemented | Pending |
