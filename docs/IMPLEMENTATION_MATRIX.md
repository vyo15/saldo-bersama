...
| `REQ-PROD-02` | Transaksi lengkap | Partial | finance service/TransactionForm + `MobileTransactionHistory` history-first UI + smart source-account picker + Kebutuhan→Alokasi suggestion + early funds feedback | `used_by`, receipt, draft, debt pending RFC-0011/0012 |
