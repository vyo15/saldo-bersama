...
2. Mantine dipilih sebagai toolkit komponen target untuk perilaku kompleks dan aksesibilitas.
...
7. Dependency Mantine telah ditambahkan bersama lockfile valid; setiap upgrade wajib mempertahankan atomic package/lock update dan full quality gate pada Node 24.
...
- Dependency Mantine tersedia, tetapi adopsi wrapper/runtime tetap bertahap dan belum mencakup seluruh primitive.
