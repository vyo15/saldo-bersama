...
- [x] Owner dan member melihat rekening personal pasangan dengan label `Pribadi · <nama pemilik>`.
...
- [x] Reaktivasi anggota eksplisit memverifikasi allowlist; self-deactivate dan last-owner guard tetap lulus.
