...
- [ ] Alokasi Kebutuhan-driven: create Alokasi tidak meminta budget awal; Tambah/Edit Kebutuhan menyesuaikan Dana Tersedia otomatis tanpa mengubah saldo ledger; shortage menjelaskan butuh/tersedia/kurang dan tidak menulis partial data; Tambah saldo mempertahankan draft; archive/delete/restore serta reuse-needs periode berikutnya menjaga funding atomic dan aman.
